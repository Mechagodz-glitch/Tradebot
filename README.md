...
tradebot thesis edit <id> --expires 2026-09-25 [--stop 4] [--target 10 | --no-target]   # change exit rules of a live thesis
                                    # --stop 0 or negative (e.g. -2) locks in profit: the stop sits at/above entry
